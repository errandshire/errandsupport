    ...
    try {
      ...
      if (result.success) {
        ...
        if (currentUser && !currentUser.isActive) {
          ...
          console.log('User not active, redirecting to onboarding');
          router.push("/onboarding");
        } else if (currentUser) {
          // Existing user, redirect based on role or intended destination
          ...
          if (redirectTo) {
            ...
            console.log('Redirecting to role-based dashboard:', dashboardRoute);
